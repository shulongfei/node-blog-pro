...
importFile("js/jquery.easyui-1.4.4.min.js");
...
//pdf预览、下载
importFile("js/plugins/pdf/pdfobject.min.js");

/**
 * PureMVC 配置脚本
 */
// APPLICATION CONSTANTS
importFile("framework/ApplicationConstants.js");
// EVENTS
importFile("framework/view/event/AppEvents.js");
// VIEW COMPONENTS
//importFile("framework/view/component/TodoForm.js");

// PROXY 
importFile("framework/model/proxy/CommonProxy.js");

// MEDIATOR 
importFile("framework/view/mediator/CommonMediator.js");

// COMAND
importFile("framework/controller/commands/CommonCommand.js");

// START COMMAND
importFile("framework/controller/boostraps/PrepControllerCommand.js");
importFile("framework/controller/boostraps/PrepModelCommand.js");
importFile("framework/controller/boostraps/PrepViewCommand.js");
importFile("framework/controller/StartupCommand.js");

// APPLICATION
importFile("framework/ApplicationFacade.js");
