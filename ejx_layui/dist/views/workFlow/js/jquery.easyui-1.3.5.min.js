 ...
 *
 * @Modifly SeeLine around 9050 | 往表格里插入TR的方法由HTML()更换成innerHTML属性方式。
 * @Modifly SeeLine around 10806 | 给combo控件添加了一个input事件绑定，解决combobox 无法中文索引。
 * @Modifly by DJQ
 *
 */
(function ($) {
...
// $(_68a).html(_68e.join("")); @djq 换成innerHTML属性方式，往表格里插入tr。
        $(_68a)[0].innerHTML = _68e.join("");
        ...
        if (!opts.disabled && !opts.readonly) {
            _80f.bind("click.combo", function (e) {
                ...
                switch (e.keyCode) {
                    ...
                    default:
                        if (opts.editable) {
                        	// @djq 给combo控件添加了一个input事件绑定，解决combobox无法中文索引的问题
                        	// 需要注意 _80f.bind("input", function (e) {}), 
                        	// 为_80f添加绑定事件是根据EasyUI版本差异而不同的,
                        	// 它是由 var q=_80f.val()来确定是那个字段.
