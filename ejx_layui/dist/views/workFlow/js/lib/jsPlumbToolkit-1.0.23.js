(function() {
    ...
    d = "undefined" != typeof jsPlumbGeom ? jsPlumbGeom: Biltong,
    e = function(a, b, d) {
        var e = c(a, b, d);
        a.splice(e, 0, b)
    },
    ...
    n = function(a, b, c, e, f, g, h, i, j, k) {
        ...
        v = function() {
            for (var g = 0; g < a.length; g++) {
                ...
                x = (a[g][2], c[a[g][1]]),
                y = m(t, x, e);
                h(a[g][1]) && d.intersects(p, y) && (n = l(p, y), o = f(a[g][1], t, n), u(w, t, o.left, o.top)),
                y = m(t, x, e);
    ...
    b.Magnetizer = function(a) {
        ...
        x = a.orderByDistanceFromOrigin,
        y = new f(u, j),
        z = a.updateOnStep,
        A = a.stepInterval || 350,
        B = a.debug,
        C = function() {
        ...
        this.executeAtEvent = function(b) {
            ...
            B && (h.style.left = b.pageX + "px", h.style.top = b.pageY + "px"),
            this.execute([e, f])
        },
...
function() {
    ...
    var c = "undefined" != typeof navigator && /MSIE\s([\d.]+)/.test(navigator.userAgent) ? new Number(RegExp.$1) : -1,
    d = c > -1 && 9 > c,
    e = function(a, b, c) {
        var d = function(b, c) {
    ...
    v = function(a, b) {
        ...
        this.compile = function(a, b) {
            ...
            return this.remove === !0 || b || (e += "_le=_els.pop();", e += "_rotors.pet(_eid, '" + this.uuid + "');"),
            e
        };
        var e = function(a, c) {
            b.each(c.split(";"),
    ...
    E(D.prototype, {
        ...
        each: function(a, b, c, d) {
            var e;
            if (j(a)) for (e = 0; e < a.length; e++) b(a[e], c, e, d);
        ...
        parse: function(a, b, c, d) {
            ...
            p = function() {
                var a = e.pop();
                return 0 == e.length && g.push(a),
                a
            },
            q = function(a, b, c, d, f) {
                var g = new v(a, d),
                h = d.customElements[g.tag];
                return h && (h.parse(g, b, c, d, e, f), h.compile && (g.compile = h.compile), g.precompile = h.precompile, g.postcompile = h.postcompile, g.custom = !0, g.remove = h.remove, d.debug("  element is a custom element"), d.maybeDebug(g.remove, "  element's root should not appear in output")),
                g
            },
            r = [{
                re: h.commentRe,
            ...
            },
            {
                ...
                handler: function(a, b, c, d) {
                    ...
                    if (null != e && e.length > 0) {
                        ...
                        d);
                        m(f),
                        o("__element", e, f, null, d)
                    }
                }
            }];
            if (f(n(a).split(this.tokenizerRe),
            function(a, c) {
        ...
        compile: function(a, b, c, d) {
            for (var e = "data=[data||{}];var frag=_rotors.cf(),_els=[],e,_le,__a,$value,$key,_eid = _rotors.nec();_els.push(frag);",
            f = "return frag;",
            g = [], h = 0; h < a.length; h++) {
                var i = "";
    ...
    H = function(a, c) {
        c = c || "rotors";
        var d, e = (b.Rotors || b).newInstance(),
        f = {},
...
function() {
    ...
    g = b.Vertex = b.Node = function(a, d, g) {
        ...
        this.deleteEdge = function(a) {
            for (var b = -1,
            c = 0; c < i.length; c++) if (i[c].getId() === a.getId()) {
                b = c;
                break
            }
        ...
        this.getIndegreeCentrality = function() {
            for (var a = 0,
            b = 0; b < l.length; b++) a += l[b].getIndegreeCentrality();
            return j + a
        },
        this.getOutdegreeCentrality = function() {
            for (var a = 0,
            b = 0; b < l.length; b++) a += l[b].getOutdegreeCentrality();
            return k + a
        },
        ...
        this.addPort = function(a, b) {
            var c = e(a, b, g),
            d = this.getPort(c);
            return null == d && (d = new h(a, b, this), l.push(d), n[d.id] = d),
            d
        },
    ...
    j = (b.Graph = function(a) {
        ...
        var r = function(a, d) {
            ...
            if ("string" != typeof a) {
                ...
                var e = a;
                if (a = l(a), "string" != typeof a) return e
            }
            var f = p ? a.split("/") : [a],
            g = function(a) {
                if (c[a]) return c[a];
        ...
        this.addVertices = this.addNodes = function(a, b) {
            for (var c = 0; c < a.length; c++) this.addVertex(a[c], b || l)
        },
        this.deleteVertex = this.deleteNode = function(a) {
            var b = r(a);
            if (b) {
                for (var e = -1,
                f = 0; f < this.vertices.length; f++) if (this.vertices[f].id === b.id) {
                    e = f;
                    break
                }
        ...
        this.getEdge = function(a) {
            if (null != a) {
                if ("string" != typeof a) {
                    ...
                    var c = a;
                    if (a = l(a), "string" != typeof a) return c
                }
                return f[a]
            }
        },
        ...
        this.getVertex = this.getNode = r,
        this.setTarget = function(a, b) {
            if (b = r(b), null == b) return {
                success: !1
            };
            var c = a.target;
        ...
        this.getDiameter = function(a) {
            for (var b = 0,
            c = 0; c < this.vertices.length; c++) for (var d = 0; d < this.vertices.length; d++) if (d != c) {
                var e = n.compute({
                    graph: this,
        ...
        this.inspect = function() {
            for (var a = "",
            b = 0; b < this.vertices.length; b++) a += this.vertices[b].inspect() + "\n";
            return a
        },
...
function() {
    ...
    a.jsPlumbToolkitInstance = function(h) {
        ...
        o = h.edgeTypeFunction ||
        function(a) {
            return a[k] || f
        },
        p = h.portIdFunction || i,
        q = h.portTypeFunction ||
        function(a) {
            return a[l] || f
        },
        r = h.portExtractor,
        ...
        y = h.edgeFactory || w,
        z = h.portFactory || w,
        A = h.autoSave && h.saveUrl,
        B = h.saveUrl,
        C = h.onAutoSaveSuccess ||
        function() {},
        D = h.onAutoSaveError ||
        function() {},
        E = h.doNotUpdateOriginalData === !0,
        F = {
        ...
        var H, I = function() {
            return null == H && (H = new jsPlumbToolkit.Model(v || {})),
            H
        },
        J = function(a, b) {
            if (null == v) return ! 0;
        ...
        this.beforeConnect = h.beforeConnect || J,
        this.beforeMoveConnection = h.beforeMoveConnection || J,
        this.beforeStartConnect = h.beforeStartConnect ||
        function(a, b) {
            return {}
        },
        this.beforeDetach = h.beforeDetach ||
        function(a, b, c) {
            return ! 0
        },
        this.beforeStartDetach = h.beforeStartDetach ||
        function(a, b) {
            return ! 0
        },
        ...
        this.connect = function(a) {
            ...
            var b;
            if (!t) {
                var d = G.getVertex(a.source),
                e = G.getVertex(a.target),
                f = a.cost,
                g = a.directed;
                if (!d) {
                    if (a.doNotCreateMissingNodes) return;
                    d = G.addVertex(a.source),
                    s.fire("nodeAdded", {
                        data: {},
                        node: d
                    })
        ...
        this.eachNode = function(a) {
            for (var b = 0,
            c = G.getVertexCount(); c > b; b++) a(b, G.getVertexAt(b))
        },
        this.eachEdge = function(a) {
            for (var b = G.getEdges(), c = 0, d = b.length; d > c; c++) a(c, b[c])
        },
        this.getEdgeCount = function() {
        ...
        this.setType = function(a, b) {
            var c = this.getType(a);
            if (c !== b) {
                var d = "Node" === a.objectType ? j: "Port" === a.objectType ? l: k,
        ...
        this.addNode = function(b, c, e) {
            ...
            if (null != g) {
                if (null != r) {
                    var h = r(g.data, g);
                    if (null != h) for (var j = 0; j < h.length; j++) g.addPort(h[j])
                }
                return P || E || a.jsPlumbToolkitIO.manage("addNode", N, O, g, i || G.getIdFunction(), s),
                e || s.fire("nodeAdded", {
                    data: b,
                    node: g,
                    eventInfo: c
        ...
        this.addNodes = function(a) {
            for (var b = 0; b < a.length; b++) s.addNode.apply(s, [a[b]]);
            return s
        },
        ...
        this.exists = function(a) {
            for (var b = 0; b < arguments.length; b++) if (null == G.getVertex(arguments[b])) return ! 1;
            return ! 0
        },
        this.removeNode = function(b, c) {
            b = b.constructor == jsPlumbGraph.Vertex || b.constructor == jsPlumbGraph.Port ? b: G.getVertex(b);
            for (var d = b.getAllEdges() || [], e = 0; e < d.length; e++) s.removeEdge(d[e]);
            return G.deleteVertex(b.id),
            P || E || a.jsPlumbToolkitIO.manage("removeNode", N, O, b, i || G.getIdFunction(), s),
            c || s.fire("nodeRemoved", {
                node: b,
                nodeId: b.id,
                edges: d
            }),
        ...
        this.addEdge = function(b, c, d) {
            var e = G.addEdge(b, n);
            return P || E || a.jsPlumbToolkitIO.manage("addEdge", N, O, e, n || G.getIdFunction(), s),
            d || s.fire("edgeAdded", {
                edge: e,
                source: c,
                geometry: b.geometry,
        ...
        this.removeEdge = function(b, c) {
            return b = G.getEdge(b),
            null != b && (G.deleteEdge(b), P || E || a.jsPlumbToolkitIO.manage("removeEdge", N, O, b, n || G.getIdFunction(), s), s.fire("edgeRemoved", {
                edge: b,
                source: c
            },
            null)),
        ...
        this.setTarget = function(a, b, c) {
            ...
            return d.success === !1 || c || s.fire("edgeTarget", d),
            d
        },
        this.setSource = function(a, b, c) {
            var d = G.setSource.apply(G, arguments);
            return d.success === !1 || c || s.fire("edgeSource", d),
            d
        },
        this.addNewPort = function(b, c, d, e) {
            ...
            function(c) {
                ...
                f = b.addPort(d);
                f.data = c,
                P || E || a.jsPlumbToolkitIO.manage("addPort", N, O, {
                    node: b,
                    port: f
                },
                p || G.getIdFunction(), s),
        ...
        this.removePort = function(a, b, c) {
            ...
            if (e) {
                ...
                if (d = a.removePort(e), d && !c) {
                    ...
                    null);
                    for (var g = 0; g < f.length; g++) s.removeEdge(f[g])
                }
            }
            return d
        },
            ...
            if (null != a) {
                ...
                try {
                    if (!b.obj || "Node" != b.type && "Edge" != b.type) {
                        for (; a.getNodeCount() > 0;) s.removeNode(a.get(0));
                        for (; a.getEdgeCount() > 0;) s.removeEdge(a.getEdge(0))
                    } else s["remove" + b.type](b.obj)
                } finally {
        ...
        this.setSuspendRendering = function(a, b) {
            for (var c in X) X[c].setSuspendRendering(a, b)
        },
        ...
        M = function(a, b, c) {
            ...
            g = function(d, e, g, h) {
                if (null != d) for (var i = d[b]({
                    ...
                    var k = e && d == G || i[j].source == d || c && i[j].source.constructor == jsPlumbGraph.Port && i[j].source.getNode() == d,
                    l = g && d == G || i[j].target == d || c && i[j].target.constructor == jsPlumbGraph.Port && i[j].target.getNode() == d; (e && k || g && l || h && (k || l)) && f(i[j])
                }
            };
            return g(L(a.source), !0, !1, !1),
            g(L(a.target), !1, !0, !1),
            g(L(a.element), !1, !1, !0),
            d
        };
        ...
        var N, O, P, Q = function(b, c, e) {
            ...
            var m = function(b) {
                ...
                P = !0,
                s.fire(c),
                a.jsPlumbToolkitIO.parse(f, b, s, k),
                W(e),
                j && j(s, b),
                s.fire("graphChanged")
            };
        ...
        this.exportData = function(b) {
            return b = b || {},
            a.jsPlumbToolkitIO.exportData(b.type || "json", s, b.parameters)
        };
        var R = function(a) {
        ...
        h.maxSelectedNodes && S.setMaxNodes(h.maxSelectedNodes),
        h.maxSelectedEdges && S.setMaxEdges(h.maxSelectedEdges),
        h.selectionCapacityPolicy && S.setCapacityPolicy(h.selectionCapacityPolicy);
        ...
        var V = function(a, b) {
            for (var c = 0; c < b.length; c++) s.fire(a, {
                obj: b[c],
                selection: S
            })
        };
        ...
        if (this.render = function(b, d) {
            ...
            c.extend(e, b),
            e.toolkit = s,
            null != b.selection && (b.selection.constructor === jsPlumbToolkitUtil.Selection ? e.toolkit = b.selection: e.toolkit = new jsPlumbToolkitUtil.Selection({
                generator: b.selection,
                toolkit: s
            }));
            var f = e.type || a.jsPlumbToolkit.DefaultRendererType,
            g = new a.jsPlumbToolkit.Renderers[f](e),
            h = e.id || jsPlumbUtil.uuid();
            return X[h] = g,
            g.id = h,
            g
        },
        ...
        this.getObjectInfo = function(a, d) {
            ...
            g = function(a) {
                var b = {};
                for (var c in X) b[c] = [X[c], X[c].getRenderedElement(a)];
                return b
            };
            if (null != a) {
...
function() {
    ...
    var d = function(a, b, c) {
        ...
        for (var h = 0; h < f.length; h++) if (f[h].nodeId) {
...
function() {
    ...
    q = b.AbstractRenderer = function(b) {
        ...
        if (this.bindToolkitEvents !== !1) {
            ...
            l.bind("graphCleared",
            function() {
                for (var a in J)"undefined" != typeof J[a]._rotors && o.remove(J[a]),
                B.remove(J[a], !0),
                delete J[a].jtk;
                p && p.clear(),
