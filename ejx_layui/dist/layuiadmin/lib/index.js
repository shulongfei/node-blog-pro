...
function(a) {
	...
	l = function(a, d) {
		...
		if (y.each(function(e) {
			...
			n = i.attr("lay-id");
			n === a && (l = !0, t.index = e)
		}), d = d || "新标签页", e.pageTabs) l || (r(s).append(['<div class="layadmin-tabsbody-item layui-show">', '<iframe src="' + a + '" frameborder="0" class="layadmin-iframe"></iframe>', "</div>"].join("")), t.index = y.length, i.tabAdd(o, {
			title: "<span>" + d + "</span>",
			id: a,
			attr: b
		}));
