...
function(e) {
	...
	A = {
		...
		sideFlexible: function(e) {
			...
			t = a("#" + h),
			s = A.screen();
			"spread" === e ? (t.removeClass(x).addClass(g), s < 2 ? i.addClass(v) : i.removeClass(v), i.removeClass(C)) : (t.removeClass(g).addClass(x), s < 2 ? i.removeClass(C) : i.addClass(C), i.removeClass(v)),
	...
	function(e) {
		e.siblings(".layui-nav-child")[0] && d.hasClass(C) && (A.sideFlexible("spread"), layer.close(e.data("index"))),
		A.tabsPage.type = "nav"
	}),
